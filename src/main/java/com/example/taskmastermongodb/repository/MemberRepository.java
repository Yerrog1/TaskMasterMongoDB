package com.example.taskmastermongodb.repository;

import com.example.taskmastermongodb.entity.Member;
...
public class MemberRepository implements MongoRepository<Member, String> {
    @Override
    public <S extends Member> S insert(S entity) {
        return null;
    }

    @Override
    public <S extends Member> List<S> insert(Iterable<S> entities) {
        return null;
    }
